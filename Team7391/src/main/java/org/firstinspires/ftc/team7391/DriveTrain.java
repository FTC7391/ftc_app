...
public class DriveTrain {
    ...
    protected static final double TICKS_PER_INCH = .9 * (TICKS_PER_REVOLUTION / (Math.PI * WHEEL_DIAMETER * GEAR_RATIO));
    protected static final double TICKS_PER_DEGREE = 1.5 * ((TICKS_PER_INCH * Math.PI * AXLE_LENGTH) / DEGREES_PER_REVOLUTION);
